...
if __name__ == "__main__":
    ...
    file_name_sales = "m5-forecasting-accuracy/sales_train_validation.csv"
    train_df = read_data(file_name_sales)
    file_name_prices = "m5-forecasting-accuracy/sell_prices.csv"
    prices_df = read_data(file_name_prices)
